...
class Sitemap extends Model
{
	...
	public function testTranslation(){
		return $this->belongsTo('WI\Sitemap\SitemapTranslation','sitemap_id')->where('locale_id',config('app.locale_id'));;
	}
	...
	public function categoriesTest(){
		return $this->belongsToMany('WI\Sitemap\Sitemap','sitemap_category','sitemap_category_id','sitemap_id');
		//->where('status','=','online');
		//->where('category','=','locatie');
		//->where('category','locatie');
	...
	public function childSitemaps(){
		return $this->hasMany('WI\Sitemap\Sitemap','parent_id','id');
		//->where('category','locatie');
